...
public class IntheCabActivity extends Activity 
{
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.inthecab);
	        ...
	        btnabout.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent i=new Intent(IntheCabActivity.this,ClickOnOverLay.class);
					startActivity(i);
					finish();
				}
			});
	        
	        Button btnthis=(Button)findViewById(R.id.Button02);
	        btnthis.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent i=new Intent(IntheCabActivity.this,ThisoneActivity.class);
					startActivity(i);
					finish();
				}
			});
