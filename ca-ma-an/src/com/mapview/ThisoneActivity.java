...
public class ThisoneActivity extends Activity 
{
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        setContentView(R.layout.thisoneactivity);
	        ...
	        Button btnarrived=(Button)findViewById(R.id.Btnabout);
	        btnarrived.setOnClickListener(new OnClickListener() {
				
				@Override
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent i=new Intent(ThisoneActivity.this,IntheCabActivity.class);
					startActivity(i);
					finish();
				}
			});
